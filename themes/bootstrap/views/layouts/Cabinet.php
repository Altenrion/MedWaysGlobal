            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown profile-menu">
                    ...
                    <ul class="dropdown-menu box profile">
                        ...
                        <li>
                            <a href="<?= Yii::app()->createUrl('ShowCase/index') ?>"><i class="fa fa-eye"></i>На
                                сайт</a>
                        </li>
        ...
        <section class="sidebar">
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?= Yii::app()->baseUrl ?>/images/avatars/<?= $this->getAvatar(); ?>" class="img-circle"
                         alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <? if ($this->checkRole(array('Dev', 'Manager'))): ?>
                    <li><a href="<?= Yii::app()->createUrl('Autorized/project') ?>"><i class="fa fa-graduation-cap"></i><span>Проект</span></a>
                    </li>
                <? endif; ?>
                <? if ($this->checkRole(array('Moder1' ,'Exp1', 'Exp2', 'Exp3', 'Dev', 'Admin'))): ?>
