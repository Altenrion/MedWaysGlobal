...
<!--                        <p>Описание мероприятия и время проведения</p>-->
<!--                    </div>-->
<!--                    <!-- /.text -->
<!--                </div>-->
                <!-- /.col-sm-4 -->
...
<!---->
                <!-- /.col-sm-4 -->
                <div class="col-sm-4 step">
                    <div class="icon"><a href="<?=Yii::app()->baseUrl.'/downloads/vuznauka_polojenie.pdf'?>" target="_blank"> <i class="icon-attach icn"></i></a> </div>
                    <!-- /.icon -->
                    <div class="text">
                        <h4>Положение об Эстафете вузовской науки </h4>
...
<div class="light-wrapper " id="">
    <div class="container inner">
        <h3 class="section-title text-center">НАУЧНЫЕ ПЛАТФОРМЫ</h3>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 step">
                    ...
                    <div class="text">
                        ...
                        <p>Приказ Минздрава России от 30.04.2013 N 281 "Об утверждении научных платформ медицинской науки " (с учетом правок от 22.05.2017 года)  </p>
                    </div>
                    <!-- /.text -->
                </div>
                <!-- /.col-sm-4 -->
