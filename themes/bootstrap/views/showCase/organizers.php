...
<div class="head-image option-4" style="background-image: url(<?=Yii::app()->baseUrl?>/images/art/ptbg4.jpg);">
    <div class="overlay dark">
        <div class="container">
            <h1 class="page-title">Организаторы </h1>
        </div>
    </div>
</div>
...
<div class="dark-wrapper" >
    <div class="container inner">
        <div class="row">
            <div class="col-sm-6">
                <h3 class="section-title">оргкомитет</h3>
                    ...
                    <ul class="post-list">
                        <li>
                            ...
                            <div class="meta">
                                ...
                                <em><a href="http://www.rosminzdrav.ru" target="_blank">www.rosminzdrav.ru</a></em> </div>
                        </li>
                        <li>
                            ...
                            <div class="meta">
                                ...
                                <em><a href="http://минобрнауки.рф" target="_blank">минобрнауки.рф</a></em> </div>
                        </li>
                        <li>
                            ...
                            <div class="meta">
                                ...
                                <em><a href="http://www.sovetrektorov.ru" target="_blank">www.sovetrektorov.ru</a></em> </div>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <div class="meta">
                                <h6><a href="#@#"> Общероссийская общественная организация "Медицинская Лига России" </a></h6>
                                <em><a href="http://www.mlross.ru" target="_blank">www.mlross.ru</a></em> </div>
                        </li>
                        <li>
                            <div class="icon-overlay icn-link"> <a href="###"><span class="icn-more"></span><img src="<?=Yii::app()->baseUrl?>/images/org/o_fmno.jpg" alt=""> </a> </div>
                            <div class="meta">
                                <h6><a href="#@#"> Федерация представителей молодежных научных обществ медицинских высших учебных заведений </a></h6>
                                <em><a href="http://fmno.ru" target="_blank">fmno.ru</a></em> </div>
                        </li>
                        <li>
