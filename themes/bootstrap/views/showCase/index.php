    ...
    <div class="fullwidthbanner">
        <ul>
            ...
            <li data-transition="fade"> <img src="<?=Yii::app()->baseUrl; ?>/images/art/map4.png" alt="" />
                <div class="caption sft" data-x="50" data-y="90" data-speed="900" data-start="500" data-easing="Sine.easeOut"><img src="<?=Yii::app()->baseUrl; ?>/images/art/slider-back1.png" alt="" /></div>
                ...
                <div class="caption sft" data-x="35" data-y="97" data-speed="900" data-start="800" data-easing="Sine.easeOut"><img src="<?=Yii::app()->baseUrl; ?>/images/art/slider-middle3.png" alt="" /></div>
                <div class="caption sft" data-x="60" data-y="105" data-speed="900" data-start="1300" data-easing="Sine.easeOut"><img src="<?=Yii::app()->baseUrl; ?>/images/art/slider-first2.png" alt="" /></div>
                <div class="caption sfr bold opacity-bg" data-x="620" data-y="270" data-speed="500" data-start="2500" data-easing="Sine.easeOut">В эстафете <?=(isset($clean_num))?($clean_num):('500') ?> ! </div>
        ...
        <div class="row bm20">
            ...
            <div class="col-sm-6">
                ...
                <div class="panel-group" id="accordion">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title"> <a data-toggle="collapse" class="panel-toggle collapsed" data-parent="#accordion" href="#collapseFour">4. Награждение финалистов  </a> </h4>
                        </div>
