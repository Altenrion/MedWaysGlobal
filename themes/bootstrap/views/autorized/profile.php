                        ...
                        <div class="col-xs-12">
                            <aside class="profile-nav alt green-border">
                                <div class="user-heading alt ">
                                    <a href="#">
                                        <img data-toggle="modal" data-target="#modalPrimary3"
                                             src="<?= Yii::app()->baseUrl ?>/images/avatars/<?= $this->getAvatar(); ?>">
                                    </a>
...
<!--                            <li><a href="#settings" data-toggle="tab">Настройки</a></li>-->
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Фамилия:</label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Имя:</label>
                                                <div class="col-sm-7 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'text',
                                                        'pk' => $data['id'],
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Отчество:</label>
                                                <div class="col-sm-7 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'text',
                                                        'pk' => $data['id'],
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Пол:</label>
                                                <div class="col-sm-7 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'select',
                                                        'name' => 'SEX',
                                                        'pk' => $data['id'],
                                                        'text' => CHtml::encode(($data['SEX']) == '1' ? 'M' : (($data['SEX'] == '2') ? 'Ж' : '-')),
                                                        'url' => $this->createUrl('Autorized/updateProfile'),
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Дата рождения:</label>
                                                <div class="col-sm-7 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'combodate',
                                                        'name' => 'BIRTH_DATE',
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 col-xs-4 control-label"
                                                       style="text-align:right ;">Телефон:</label>
                                                <div class="col-sm-7 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'text',
                                                        'pk' => $data['id'],
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Ученая степень:</label>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Ученое звание:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'select',
                                                        'name' => 'ACADEMIC_TITLE',
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Округ:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'select',
                                                        'name' => 'ID_DISTRICT',
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Вуз:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'select',
                                                        'name' => 'ID_UNIVER',
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Должность:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'text',
                                                        'pk' => $data['id'],
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Специальность:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'select',
                                                        'name' => 'ID_SPECIALITY',
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 col-xs-4 control-label"
                                                       style="text-align:right ;">Индекс Хирша:</label>
                                                <div class="col-sm-8 col-xs-8">
                                                    <? $this->widget('editable.Editable', array(
                                                        'type' => 'text',
                                                        'pk' => $data['id'],
                                        ...
                                        <? } else { ?>
                                            <div class="grid-body">
                                                <div class="alert alert-danger fade in">
                                                    ...
                                                    <p>По не установленным причинам на сервере произошел технический
                                                        сбой! Убедительная просьба перезайти в сой кабинет,
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 stats">
                                        ...
                                        <a class="btn btn-primary"
                                           href="<?= Yii::app()->createUrl('Autorized/profile') ?>"><i
                                    ...
                                    <? if ($this->checkRole(array('Manager'))): ?>
                                        <div class="col-sm-4 stats">
                                            ...
                                            <a href="<?= Yii::app()->createUrl('Autorized/project') ?>"
                                               class="btn btn-info"><i class="fa fa-graduation-cap"></i> Проект</a>
                                        </div>
                                    <? endif; ?>
                                ...
                                <div class="tab-pane" id="settings">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-horizontal">
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Дублировать оповещения по
                                                        email</label>
                                                    <div class="col-sm-2">
                                                        <input type="checkbox" class="js-switch">
                                                    </div>
                                                    <label class="col-sm-2 control-label"> Подписаться на
                                                        новости</label>
                                                    <div class="col-sm-2">
                                                        <input type="checkbox" class="js-switch">
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-4 control-label">Дублировать обращениия по
                                                        email</label>
                                                    <div class="col-sm-2">
                                                        <input type="checkbox" class="js-switch">
                                                    </div>
    ...
    <div class="modal fade" id="modalPrimary3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel14"
         aria-hidden="true">
                ...
                <div class="modal-content bg-blue">
                    ...
                    <div class="modal-body">
                        <p style="font-size:13px;">
                            Здравствуйте <?= Yii::app()->user->name ?>! В данном окне вы можете выбрать и загрузить
                            фотографию для своей учетной записи. Напоминаем вам что
                            рекомендуемый размер фотографий : 500x500 пикс. ; Если вы уже загружали изображение ранее,
                            применено для вашей
                            учетной записи будет последнее.

                        </p>
                        </br>
                        <form action="<?= Yii::app()->createUrl('Images/upload') ?>" method="post"
