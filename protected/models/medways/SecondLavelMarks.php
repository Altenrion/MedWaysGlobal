...
/**
 * This is the model class for table "m_w_second_lavel_marks".
 *
 * The followings are the available columns in table 'm_w_second_lavel_marks':
 ...
 */
class SecondLavelMarks extends CActiveRecord
{
	/**
	 ...
	 * @return SecondLavelMarks the static model class
	 */
